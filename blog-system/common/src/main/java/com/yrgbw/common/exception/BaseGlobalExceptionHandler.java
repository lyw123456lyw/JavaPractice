...
//        return DefaultErrorResult.failure(ResponseStatus.PARAM_IS_INVALID, e, HttpStatus.BAD_REQUEST, parameterInvalidItemList);
//    }
    ...
    public DefaultErrorResult handleConstraintViolationException(HttpMessageNotReadableException e, HttpServletRequest request) {
        log.info("handleConstraintViolationException start, uri:{}, caused by: ", request.getRequestURI(), e);
        return DefaultErrorResult.failure(ResponseStatus.PARAM_IS_INVALID, e, HttpStatus.BAD_REQUEST);
    }
...
//    }
    ...
    protected DefaultErrorResult handleRuntimeException(RuntimeException e, HttpServletRequest request) {
        ...
        return DefaultErrorResult.failure(ResponseStatus.INTERFACE_ADDRESS_INVALID, e, HttpStatus.INTERNAL_SERVER_ERROR);
    }
