...
import com.yrgbw.common.utils.StringUtil;
...
public class DefaultErrorResult implements Result {
    ...
    /**
     * 我们系统内部自定义的返回值编码，{@link } 它是对错误更加详细的编码
     *
    ...
    public static DefaultErrorResult failure(ResponseStatus resultCode, Throwable e, HttpStatus httpStatus, Object errors) {
        DefaultErrorResult result = DefaultErrorResult.failure(resultCode, e, httpStatus);
        result.setErrors(errors);
        return result;
    }

    public static DefaultErrorResult failure(ResponseStatus resultCode, Throwable e, HttpStatus httpStatus) {
...
//    public static DefaultErrorResult failure(NativeException e) {
//        StatusCode ee = StatusCode.getByEClass(e.getClass());
//        if (ee != null) {
